...
let n17 = new ElementNode({ x: 0, y: 11.5 })
let n18 = new ElementNode({ x: 5.79, y: 11.5 })
let n19 = new ElementNode({ x: 11.19, y: 11.5 })
let n20 = new ElementNode({ x: 15.19, y: 11.5 })

let n21 = new ElementNode({ x: 0, y: 14.3 })
let n22 = new ElementNode({ x: 5.79, y: 14.3 })
let n23 = new ElementNode({ x: 11.19, y: 14.3 })
let n24 = new ElementNode({ x: 15.19, y: 14.3 })

let n25 = new ElementNode({ x: 0, y: 17.1 })
let n26 = new ElementNode({ x: 5.79, y: 17.1 })
let n27 = new ElementNode({ x: 11.19, y: 17.1 })
let n28 = new ElementNode({ x: 15.19, y: 17.1 })
...
let er3 = (c5x5.h - 0.04 * 2 - barn7.diameter) / 3
...
//LOAD BEAMS
bS.forEach((b) => {
	new RectangularSpanLoad(b, 15.65)
})
bR.forEach((b) => {
	new RectangularSpanLoad(b, 7.19)
})
let cS = [
	col1,
	col2,
