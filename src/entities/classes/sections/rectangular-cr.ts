...
export class RectangularSectionCR implements IRectangularSectionCR {
    ...
    public addRowReinforcement(d:number,quantity: number,BarCR: BarCR):void{
    ...
    public swapRowReinforcement(d:number,quantity: number,BarCR: BarCR):void{
